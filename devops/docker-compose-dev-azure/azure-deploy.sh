...
resourcename="01j9v3260mr7rsfsv02r522zg2"  # lower case, only
resourcegroup="01j9v3260mr7rsfsv02r522zg2_rg"
...
# git clone https://github.com/apilogicserver/01j9v3260mr7rsfsv02r522zg2.git
# cd 01j9v3260mr7rsfsv02r522zg2
...
az group create --name 01j9v3260mr7rsfsv02r522zg2_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group 01j9v3260mr7rsfsv02r522zg2_rg --sku S1 --is-linux
az container create --resource-group 01j9v3260mr7rsfsv02r522zg2_rg --name 01j9v3260mr7rsfsv02r522zg2 --image apilogicserver/01j9v3260mr7rsfsv02r522zg2:latest --dns-name-label 01j9v3260mr7rsfsv02r522zg2 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//01j9v3260mr7rsfsv02r522zg2.westus.azurecontainer.io:5656'
